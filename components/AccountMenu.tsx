    ...
    <div className="bg-[#00000099]/70 w-56 absolute top-14 right-0 py-5 flex-col border-2 rounded-md backdrop-blur-md border-gray-800 flex">
      <div className="flex flex-col gap-3">
        <div className="px-3 group/item flex flex-row gap-3 items-center w-full">
          <img className="w-8 h-8 " src="/images/vr.png" alt="" />
          <p className="text-white font-bold text-md group-hover/item:text-blue-400 group-hover/item:transition group-hover/item:ease-in-out group-hover/item:duration-300">{currentUser?.name}</p>
        </div>
      </div>
